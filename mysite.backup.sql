...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$320000$918lKGpSM0ciT62YssovH4$bvg4LHqIfINWqdmFowR3UokTj53UrQgzj+vv86x6Ug0=','2023-10-23 07:54:37.640395',1,'dushiyi','','','',1,1,'2023-10-23 06:17:30.841019');
...
INSERT INTO `django_admin_log` VALUES (1,'2023-10-23 07:04:59.225496','1','Tool object (1)',1,'[{\"added\": {}}]',17,1);
...
CREATE TABLE `product_vector` (
  ...
  `vector_map` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `C_Gene` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `V_Gene` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dump completed on 2023-10-23 18:58:00
